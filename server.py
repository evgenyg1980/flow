...
def split_audio():
    """פונקציה שמקבלת קובץ ומחלקת אותו לחלקים של 10 דקות"""
    ...
    parts = [f"/download/{f}" for f in os.listdir(OUTPUT_FOLDER) if f.endswith(".mp3")]
...
def download_file(filename):
    """שירות שמאפשר גישה לקבצים המחולקים"""
